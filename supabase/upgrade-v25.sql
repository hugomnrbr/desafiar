-- QuizUp v25 - cronômetro e feedback de resposta
-- Execute DEPOIS do upgrade-v24.sql/v23. Não recrie o schema.
-- A mudança importante é que a próxima rodada começa imediatamente em 10s;
-- não existe mais a transição de 3 segundos entre perguntas.
